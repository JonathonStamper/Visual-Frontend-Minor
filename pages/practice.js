  ...
  return (
    ...
    <div className=" flex gap-5 items-center">
      ...
      <div className="loader flex gap-5">
        ...
        <span key={item.number} style={{'--i': item.number, '--c': item.color}}></span>
))}
    ...
    <div className=" flex gap-5 justify-center items-center relative">
      ...
      {loaderList.map((item, index) => (        
        <span key={item.number} style={{'--i2': item.number, '--c2': item.color}}></span>
))}
    ...
    <div className=" flex gap-5 justify-center items-center relative">
      ...
      {loaderList.map((item, index) => (        
        <span key={item.number} style={{'--i3': item.number, '--c3': item.color}}></span>
))}
    ...
    <div className=" flex gap-5 justify-center items-center relative">
      ...
      {loaderList.map((item, index) => (        
        <span key={item.number}  style={{'--i4': item.number, '--c4': item.color}}></span>
))}
    ...
    <div className=" flex gap-5 justify-center items-center relative">
      ...
      {loaderList.map((item, index) => (        
        <span key={item.number} className={'planet' + item.number} style={{'--i5': item.number, '--c5': item.color}}></span>
))}
    ...
    <div className=" flex gap-5 justify-center items-center relative">
      ...
      {loaderList.map((item, index) => (        
        <span key={item.number} className={'planet' + item.number} style={{'--i6': item.number, '--c6': item.color}}></span>
))}
